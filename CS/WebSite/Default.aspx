...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Editors_ListBoxItemFiltering_ListBoxItemFiltering" %>
                ...
                <dxrp:PanelContent ID="PanelContent1" runat="server">
                    <table cellpadding="0" cellspacing="0" class="gameTable">
                        <tr>
                            ...
                            <td valign="top">
                                <%-- Filter box --%>
                                <dxe:ASPxTextBox ID="tbFilterBox_GameName" runat="server" Width="200px" ClientInstanceName="filterBox" Text="un">
                        ...
                        <tr>    
                            <td colspan="2" class="gamesMenu" align="center" valign="top">
                                <%-- Callback panel --%>
                                <dxcp:ASPxCallbackPanel ID="cpCallbackPanel" runat="server" Width="100%" ClientInstanceName="callbackPanel" OnCallback="OnCallback" Height="320px">
                                    ...
                                    <PanelCollection>
                                        <dxrp:PanelContent runat="server">
                                           <div class="listBoxWrapper" onkeyup="OnListBoxKeyUp(event);" onkeypress="OnListBoxKeyPress(event);">
                                               <%-- Games list --%>
                                               <dxe:ASPxListBox ID="lbGames" runat="server" Width="240px" Height="300px" ClientInstanceName="games" EncodeHtml="False" />
